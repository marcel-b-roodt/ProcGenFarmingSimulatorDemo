...
public class TomatoCropEntity : StaticBody2D, ICrop
{
	...
	{
		{ ItemMetadataID.consumable_crop_tomato, 100 },
		{ ItemMetadataID.seeds_tomato, 33 }
	};

	IEntityData IEntity.Data { get { return Data; } }
	public TomatoCropData Data { get; private set; }
	...
	{
		Data = (TomatoCropData)entityData;
