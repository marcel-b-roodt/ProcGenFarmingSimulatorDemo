...
public class ArtichokeCropEntity : StaticBody2D, ICrop
{
	...
	{
		{ ItemMetadataID.consumable_crop_artichoke, 100 },
		{ ItemMetadataID.seeds_artichoke, 33 }
	};

	IEntityData IEntity.Data { get { return Data; } }
	public ArtichokeCropData Data { get; private set; }
	...
	public InventoryCropSeedType CropType => InventoryCropSeedType.Artichoke;
	...
	{
		Data = (ArtichokeCropData)entityData;
