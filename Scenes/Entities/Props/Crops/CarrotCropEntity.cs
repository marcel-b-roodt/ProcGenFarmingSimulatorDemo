...
public class CarrotCropEntity : StaticBody2D, ICrop
{
	...
	{
		{ ItemMetadataID.consumable_crop_carrot, 100 },
		{ ItemMetadataID.seeds_carrot, 100 }
	};

	IEntityData IEntity.Data { get { return Data; } }
	public CarrotCropData Data { get; private set; }
	...
	public InventoryCropSeedType CropType => InventoryCropSeedType.Carrot;
	...
	{
		Data = (CarrotCropData)entityData;
