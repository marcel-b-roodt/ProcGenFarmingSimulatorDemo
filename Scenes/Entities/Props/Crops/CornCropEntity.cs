...
public class CornCropEntity : StaticBody2D, ICrop
{
	...
	{
		{ ItemMetadataID.consumable_crop_corn, 100 },
		{ ItemMetadataID.seeds_corn, 33 }
	};

	IEntityData IEntity.Data { get { return Data; } }
	public CornCropData Data { get; private set; }
