...
public class GourdCropEntity : StaticBody2D, ICrop
{
	...
	{
		{ ItemMetadataID.consumable_crop_gourd, 100 },
		{ ItemMetadataID.seeds_gourd, 33 }
	};

	IEntityData IEntity.Data { get { return Data; } }
	public GourdCropData Data { get; private set; }
	...
	public InventoryCropSeedType CropType => InventoryCropSeedType.Gourd;
